...
**Overall:** 60/153 done (39%) · 35 available · 58 blocked
...
- `code-ui-career-hub` [code/ui] (default) — Career hub shell (stub tiles Map/Shop/Garage + live RACE tile)
...
flowchart LR
  subgraph code
    ...
    code_ui_career_hub["ui-career-hub"]
