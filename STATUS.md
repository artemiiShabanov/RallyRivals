...
**Overall:** 72/156 done (46%) · 33 available · 51 blocked
...
- `code-meta-shop` [code/meta] (default) — Always-open price-gated car shop
- `code-meta-garage` [code/meta] (default) — Owned-cars garage + selection
...
- `code-ui-prerace-carselect` — waiting on: code-meta-garage
...
flowchart LR
  subgraph code
    ...
    code_ui_prerace_carselect["ui-prerace-carselect"]
  ...
  code_meta_garage --> code_ui_prerace_carselect
