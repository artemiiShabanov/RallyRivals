...
**Overall:** 36/147 done (24%) · 44 available · 67 blocked
...
- `code-ui-hud` [code/ui] (default) — Basic HUD (speed / position / timer)
...
- `design-playtest-slice` — waiting on: code-ui-results, audio-sfx-engine, art-voxel-car-kerb
...
flowchart LR
  ...
  class code_track_seasons,code_track_props,code_track_ai_line,code_track_weather_grip,code_vehicle_damage,code_vehicle_brand_features,code_vehicle_airborne,code_core_scene_flow,code_core_pooling,code_race_defs,code_race_result,code_race_types,code_race_timetrial,code_ui_statbars,code_ui_hud,code_meta_currencies,code_meta_classes,content_rivals_defs,content_tracks_first,art_voxel_props,art_voxel_environment,art_voxel_brand_families,art_voxel_car_kerb,art_vfx_juice,art_vfx_surface_particles,art_vfx_weather,art_ui_hud_gfx,art_ui_theme,art_world_terrain_tex,art_world_skybox,art_world_lighting,art_shader_surface,art_shader_road,audio_sfx_engine,audio_sfx_surface,audio_sfx_ui,audio_sfx_ambient,audio_music_direction,balance_handling_feel,balance_handling_classes,balance_economy_tables,design_spec_vehicle,design_spec_field_matching,setup_build_export avail;
  class code_track_conditions,code_vehicle_slipstream,code_core_save,code_core_settings_apply,code_race_endurance,code_race_grandprix,code_race_contact,code_ai_rival,code_ai_difficulty,code_ai_boss,code_ui_menus,code_ui_loading,code_ui_prerace,code_ui_results,code_ui_career_map,code_ui_shop,code_ui_garage,code_ui_boss_intro,code_ui_pause,code_meta_economy,code_meta_shop,code_meta_garage,code_meta_pinkslip,code_meta_achievements,code_meta_chapters,content_rivals_campaign,content_rivals_story,content_tracks_campaign,art_voxel_car_mule,art_voxel_car_spark,art_voxel_car_tangent,art_voxel_car_crowbar,art_voxel_car_fuse,art_voxel_car_meridian,art_voxel_car_anvil,art_voxel_car_strobe,art_voxel_car_verdict,art_voxel_car_sledge,art_voxel_car_comet,art_voxel_car_stiletto,art_voxel_car_juggernaut,art_voxel_car_nova,art_voxel_wheel_apex,art_voxel_wheel_wreck,art_voxel_wheel_mayfly,art_vfx_slipstream,art_vfx_damage,art_vfx_nitro,art_ui_portraits,art_ui_boss_anim,art_ui_paint_skins,art_world_regions,art_world_seasons,audio_sfx_impact,audio_sfx_slipstream,audio_sfx_nitro,audio_music_menu,audio_music_race,audio_music_boss,balance_difficulty_ai,balance_difficulty_pacing,balance_surfaces_grip,design_playtest_race,design_playtest_slice,design_playtest_loop,setup_build_platforms,setup_build_launch blocked;
```
