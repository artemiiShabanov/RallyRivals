...
**Overall:** 53/156 done (34%) · 38 available · 65 blocked
...
## Available now (38 unblocked)

- `art-shader-vhs` [art/shader] (default) — VHS tape post-process (grain/bleed/tracking; intensity slider + off switch)
- `art-ui-hud-gfx` [art/ui-art] (default) — Telemetry scorebug HUD graphics (broadcast lower-third)
- `art-ui-theme` [art/ui-art] (big) — VHS broadcast UI theme (white-on-blue VCR-OSD) + OSD font
- `art-ui-sal` [art/ui-art] (default) — Big Sal host art (teleshopping + sign-off talking-head)
- `art-ui-station-ident` [art/ui-art] (small) — Station ident: SAL'S corner bug + sign-off card
...
- `code-race-result` [code/race] (default) — Win/lose + finishing place
...
- `code-ui-ticker` [code/ui] (small) — Commentary ticker / chyron (scrolling broadcast text)
- `code-ui-broadcast-cards` [code/ui] (default) — Broadcast cards + bumpers (LIVE / UP NEXT / OWNERSHIP TRANSFERRED / sign-off)
...
- `content-broadcast-copy` [content/broadcast] (default) — Broadcast copy: Big Sal ad reads + ticker lines + card text
...
flowchart LR
  subgraph code
    ...
    code_ui_ticker["ui-ticker"]
    code_ui_broadcast_cards["ui-broadcast-cards"]
  ...
  subgraph art
    ...
    art_ui_sal["ui-sal"]
    art_ui_station_ident["ui-station-ident"]
  ...
  subgraph content
    ...
    content_broadcast_copy["broadcast-copy"]
  ...
  class code_track_seasons,code_track_props,code_track_ai_line,code_vehicle_damage,code_vehicle_brand_features,code_vehicle_airborne,code_core_scene_flow,code_core_pooling,code_race_result,code_race_types,code_race_timetrial,code_ui_statbars,code_ui_ticker,code_ui_broadcast_cards,code_meta_currencies,code_meta_classes,content_rivals_defs,content_broadcast_copy,content_tracks_first,art_voxel_props,art_voxel_environment,art_voxel_brand_families,art_voxel_car_kerb,art_vfx_juice,art_ui_hud_gfx,art_ui_theme,art_ui_sal,art_ui_station_ident,art_world_terrain_tex,art_world_skybox,art_shader_vhs,audio_music_direction,balance_handling_feel,balance_handling_classes,balance_economy_tables,balance_surfaces_grip,design_spec_field_matching,setup_build_export avail;
  class code_vehicle_slipstream,code_core_save,code_core_settings_apply,code_race_endurance,code_race_grandprix,code_race_contact,code_ai_rival,code_ai_difficulty,code_ai_boss,code_ui_menus,code_ui_loading,code_ui_prerace,code_ui_results,code_ui_career_map,code_ui_shop,code_ui_garage,code_ui_boss_intro,code_ui_pause,code_ui_scorebug,code_meta_economy,code_meta_shop,code_meta_garage,code_meta_pinkslip,code_meta_achievements,code_meta_chapters,content_rivals_campaign,content_rivals_story,content_tracks_campaign,art_voxel_car_mule,art_voxel_car_spark,art_voxel_car_tangent,art_voxel_car_crowbar,art_voxel_car_fuse,art_voxel_car_meridian,art_voxel_car_anvil,art_voxel_car_strobe,art_voxel_car_verdict,art_voxel_car_sledge,art_voxel_car_comet,art_voxel_car_stiletto,art_voxel_car_juggernaut,art_voxel_car_nova,art_voxel_wheel_apex,art_voxel_wheel_wreck,art_voxel_wheel_mayfly,art_vfx_slipstream,art_vfx_damage,art_vfx_nitro,art_ui_portraits,art_ui_boss_anim,art_ui_paint_skins,art_world_regions,art_world_seasons,audio_sfx_slipstream,audio_sfx_nitro,audio_music_menu,audio_music_race,audio_music_boss,balance_difficulty_ai,balance_difficulty_pacing,design_playtest_race,design_playtest_slice,design_playtest_loop,setup_build_platforms,setup_build_launch blocked;
```
