...
**Overall:** 13/121 done (11%) · 46 available · 62 blocked
...
- `code-track-checkpoints` [code/track] (default) — Checkpoint gates baked from the spline
...
- `design-gdd-adr-sync` [design/gdd] (small) — Sync GDD 4/7 with decided ADR-001/002
...
flowchart LR
  ...
  subgraph design
    ...
    design_gdd_adr_sync["gdd-adr-sync"]
