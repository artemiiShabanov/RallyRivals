...
**Overall:** 22/127 done (17%) · 44 available · 61 blocked
...
- `code-tools-map-editor-surface` [code/tools] (big) — Map editor: surface paint brush (palette from .tres, sizes, off-road eraser)
- `code-tools-map-editor-race` [code/tools] (big) — Map editor: race tools (start/dir/gate pairs + validation)
- `code-tools-map-editor-props` [code/tools] (small) — Map editor: prop stamp tool
