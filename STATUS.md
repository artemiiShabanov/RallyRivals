...
**Overall:** 30/129 done (23%) · 44 available · 55 blocked
...
- `art-world-palette` [art/world] (small) — Master colour palette (voxel + terrain ramps, ADR-003)
...
- `art-voxel-car-first` — waiting on: art-voxel-car-blockout, art-world-palette
...
flowchart LR
  ...
  subgraph art
    ...
    art_world_palette["world-palette"]
  ...
  art_world_palette --> art_voxel_car_first
  ...
  class code_track_seasons,code_track_props,code_track_ai_line,code_track_weather_grip,code_vehicle_damage,code_vehicle_stats,code_vehicle_brand_features,code_vehicle_airborne,code_core_scene_flow,code_core_pooling,code_race_defs,code_race_result,code_race_types,code_race_timetrial,code_ui_statbars,code_ui_hud,code_meta_currencies,content_cars_roster,content_rivals_defs,content_tracks_first,art_voxel_car_blockout,art_voxel_props,art_voxel_environment,art_vfx_juice,art_vfx_surface_particles,art_vfx_weather,art_ui_hud_gfx,art_ui_theme,art_world_terrain_tex,art_world_palette,art_world_skybox,art_world_lighting,art_shader_surface,art_shader_road,audio_sfx_engine,audio_sfx_surface,audio_sfx_ui,audio_sfx_ambient,audio_music_direction,balance_handling_feel,balance_economy_tables,design_spec_vehicle,design_spec_field_matching,setup_build_export avail;
