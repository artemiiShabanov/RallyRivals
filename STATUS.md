...
**Overall:** 23/127 done (18%) · 44 available · 60 blocked
...
- `code-tools-map-editor-height` [code/tools] (huge) — Map editor: auto-heightmap from road + height control points
...
- `code-tools-map-editor-export` — waiting on: code-tools-map-editor-race
