...
**Overall:** 54/156 done (35%) · 37 available · 65 blocked
...
flowchart LR
  ...
  class code_track_seasons,code_track_props,code_track_ai_line,code_vehicle_damage,code_vehicle_brand_features,code_vehicle_airborne,code_core_scene_flow,code_core_pooling,code_race_result,code_race_types,code_race_timetrial,code_ui_statbars,code_ui_ticker,code_ui_broadcast_cards,code_meta_currencies,code_meta_classes,content_rivals_defs,content_broadcast_copy,content_tracks_first,art_voxel_props,art_voxel_environment,art_voxel_brand_families,art_voxel_car_kerb,art_vfx_juice,art_ui_hud_gfx,art_ui_theme,art_ui_sal,art_ui_station_ident,art_world_terrain_tex,art_world_skybox,audio_music_direction,balance_handling_feel,balance_handling_classes,balance_economy_tables,balance_surfaces_grip,design_spec_field_matching,setup_build_export avail;
