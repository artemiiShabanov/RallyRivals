...
**Overall:** 17/127 done (13%) · 44 available · 66 blocked
...
- `code-track-bake-tool` [code/tools] (default) — Bake tool as in-editor @tool button
- `code-tools-map-editor-shell` [code/tools] (huge) — Map editor: canvas shell (zoom/pan, blueprint underlay, layer toggles, save/load)
- `code-track-test-track` [code/track] (default) — Gray-box test track (authored images + tuned TrackPath)
...
- `design-playtest-firstdrive` — waiting on: code-track-test-track
